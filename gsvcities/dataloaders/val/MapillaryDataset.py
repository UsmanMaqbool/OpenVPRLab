...
DATASET_ROOT = '/home/m.maqboolbhutta/usman_ws/datasets/Mapillary_Street_Level_Sequences/'
GT_ROOT = './gsvcities/datasets/' # BECAREFUL, this is the ground truth that comes with GSV-Cities
